...
<main id="main" role="main" >
    ...
    <div class="backdrop-brightness-75 dark:backdrop-brightness-50 backdrop-blur-sm h-full">
      <div class="flex mx-auto max-w-5xl px-3 h-full items-center">
        <article class="flex-col py-12 md:py-32">
          <div class="flex-col">
            <h1 class="pb-4"><a href="https://fuelviews.com/"><span class="font-extrabold text-white text-3xl md:text-4xl lg:text-5xl text-shadow-lg">
                Our product is service.</span</a></h1>
  ...
  <div
    class="flex-col w-full max-w-5xl mx-auto px-3 py-16 prose lg:prose-xl dark:prose-invert">
    <?php
    function image1()
    {
        $imgName = "/images/fv";
